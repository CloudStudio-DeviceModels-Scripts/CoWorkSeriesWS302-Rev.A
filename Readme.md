...
# Configuration Script – CoWork Series WS302 - Rev. A

This **Configuration** script is designed for the **CoWork Series WS302** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – CoWork Series WS302 Rev. A

Este script de **Configuration** está diseñado para el modelo **CoWork Series WS302** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
